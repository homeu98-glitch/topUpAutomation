import { applyCors, revokeRejectedTransaction } from "../../lib/topup-service.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const data = await revokeRejectedTransaction({
    ...
    return res.status(500).json({
      error: error instanceof Error ? error.message : "撤回失敗",
    });
  }
}
