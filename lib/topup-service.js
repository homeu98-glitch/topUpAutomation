...
3a. 如果畫面同時有「消費原金額 / 原金額 / 訂單金額 / 付款項目中的訂單金額」以及「折扣後實付金額」，而系統業務應以原交易充值金額入帳，請優先選擇原交易金額。例如原金額 210、折扣後支付 140，amount 應輸出 210。
3b. 若「付款項目」、「訂單項目」、「中銀訂單MOP210.00」這類欄位內含明確訂單金額，這是強訊號，應優先納入判斷。
